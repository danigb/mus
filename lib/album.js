...
Album.prototype.createMeta = function (cb) {
  ...
  loadTrackInfo(this.path, meta, function (err, meta) {
    if (err) cb(err, null)
    normalizeMeta(meta)
    cb(null, meta)
  })
...
function normalizeMeta (meta) {
  function collectInfo (name, track) {
    if (!meta[name]) meta[name] = track[name]
    if (meta[name] === track[name]) delete track[name]
  }
...
function loadTrackInfo (root, meta, cb) {
  var pending = 0
  meta.tracks.forEach(function (track) {
